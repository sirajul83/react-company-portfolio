                ...
                <div className="row pt-5">
                    <div className="col-lg-4 col-md-6 mb-5">
                        ...
                        <div className="d-flex justify-content-start mt-4">
                            <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style={{width: '38px', height: '38px'}} target="_blank"  href={companyinfo.twitter}><i className="fab fa-twitter"></i></a>
                            <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style={{width: '38px', height: '38px'}} target="_blank"  href={companyinfo.facebook}><i className="fab fa-facebook-f"></i></a>
                            <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style={{width: '38px', height: '38px'}} target="_blank"  href={companyinfo.linkedIn}><i className="fab fa-linkedin-in"></i></a>
                            <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style={{width: '38px', height: '38px'}} target="_blank"  href={companyinfo.youtube}><i className="fab fa-instagram"></i></a>
                        </div>
                    </div>
